...
class Current extends Component {
  ...
  render() {
    ...
    if(this.props.renderGraph){
      ...
      noGraph = (
        <Text style={styles.noDataHeadingStyle}>No Current Data Available</Text>
      )
    }
    if(this.props.spinner){
      body =(
        <View  style={styles.activityIndicatorContainerStyles}>
          ...
          <Text style={styles.activityIndicatorTextStyles}>Current Activity Loading</Text>
        </View>
      )
    }else{
